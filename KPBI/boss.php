		...
		<nav id="nav" class="navbar nav-transparent">
			<div class="container">
				...
				<ul class="main-nav nav navbar-nav navbar-right">
					<li><a href="boss.php">Home</a></li>
					<li><a href="berkas_boss.php">Berkas</a></li>
					<li><a href="logout.php">Logout</a></li>
					<li><a href="#about">Halo Boss!</a></li>
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							<h1 class="black-text">Dokumentasi Proyek</h1>
							<h2 class="black-text">Pemetaan Proses Bisnis dan Penyusunan Risk Control Matrix</h2>
							<h2 class="black-text">Departemen Audit Intern</h2>
							<h3 class="black-text">"One BI Working Together Towards The Strongest One"
							</h3>

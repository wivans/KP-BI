			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-4">
						<h2 class="white-text">Upload Berkas</h2>
							<form method="POST" action="input.php">
						        <div class="input-group">
						          <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
						          <input id="email" type="text" class="form-control" name="nama" placeholder="Nama File">
						        </div>
						        <br>
						        <div class="input-group">
						          <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
									<input id="password" type="text" class="form-control" name="pic" placeholder="PIC">
						        </div>
						         <br>
						         <div class="input-group">
						          <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
									<input id="password" type="date" class="form-control" name="tanggalm" placeholder="Tanggal mulai">
						        </div>
						         <br>
						         <div class="input-group">
						          <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
									<input id="password" type="date" class="form-control" name="tanggals" placeholder="Tanggal selesai">
						        </div>
						         <br>
						         <div class="input-group">
						          <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>

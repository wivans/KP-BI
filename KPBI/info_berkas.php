...
<div class="container">
	<div class="row">
		...
		<section class="content" style="margin-top: 20px;">
			<h1 style="text-align: center;" class="black-text">Info Berkas</h1>
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="pull-right">
							<div class="btn-group">
								<button type="button" class="btn btn-success btn-filter" data-target="Setuju">Setuju</button>
								<button type="button" class="btn btn-danger btn-filter" data-target="Tolak">Tolak</button>
								<button type="button" class="btn btn-info btn-filter" data-target="Menunggu">Menunggu</button>
								<button type="button" class="btn btn-default btn-filter" data-target="all">Berkas</button>
							</div>
						</div>
						<div class="pull-left">
							<div class="btn-group">
								<a href="berkas.php"><button type="button" class="btn btn-danger">Upload</button></a>
							</div>
						</div>
										...
										<td>
											<div class="media">
												<div class="media-body">
													<span class="pull-right pagado">'.$data['Status'].'</span>
